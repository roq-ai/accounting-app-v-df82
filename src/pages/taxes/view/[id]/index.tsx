...
import { getTaxById } from 'apiSdk/taxes';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('tax', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/taxes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Tax Type" text={data?.tax_type} />

                <FormListItem label="Tax Rate" text={data?.tax_rate} />
