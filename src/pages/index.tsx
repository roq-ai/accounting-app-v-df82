...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Accounting APP v2`}</title>

        <meta
          name="description"
          content="Experience seamless financial management with Accounting APP v2. Ensuring user-specific access, personalized dashboards, robust accounting functions, efficient invoicing, meticulous expense management, comprehensive financial reporting, accurate tax compliance, bank integration, and multi-language support. Your secure solution for document management and audit trails. Stay updated with notifications and alerts. Transform your financial journey today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless financial management with Accounting APP v2. Ensuring user-specific access, personalized dashboards, robust accounting functions, efficient invoicing, meticulous expense management, comprehensive financial reporting, accurate tax compliance, bank integration, and multi-language support. Your secure solution for document management and audit trails. Stay updated with notifications and alerts. Transform your financial journey today.`}
            </Text>
            <Box
